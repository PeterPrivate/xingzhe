...
public class MysqlGenerator {
	...
	public static void main(String[] args) {
		...
		String outputDir = "C:\\Users\\guanxy\\Desktop";
...
//		strategy.setTablePrefix(new String[] { "bmd_", "mp_" });// 此处可以修改为您的表前缀
		strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
		 strategy.setInclude(new String[] { "user","role","resource","user_role","role_resource","organization","sys_log","tb_article","tb_invitation","tb_open_class","tb_slideshow","tb_tutor","tb_type_article","tb_type_domain","tb_type_source" }); // 需要生成的表
		...
		// 自定义 controller 父类
		//strategy.setSuperControllerClass("com.xingzhe.commons.base.BaseController");
		...
		pc.setParent("com.gxy"); // 自定义包路径
		pc.setController("controller"); // 这里是控制器包名，默认 web
		pc.setEntity("entity");//存放实体类的类名
		pc.setXml("mapper");//存放mapper xml文件的类名
