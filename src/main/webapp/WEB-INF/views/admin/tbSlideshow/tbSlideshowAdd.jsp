...
<script type="text/javascript">
    $(function() {
        $('#tbSlideshowAddForm').form({
            url : '${path}/tbSlideshow/add',
            onSubmit : function() {
                progressLoad();
    ...
    $(function(){
        ...
        $('.radioSpan input:radio[name=isArticle][value="0"]').click();
        $('#articleId').combobox({
            prompt:'输入关键字自动检索',
            required:false,
            mode:'remote',
...
<div class="easyui-layout" data-options="fit:true,border:false" >
    <div data-options="region:'center',border:false" style="overflow: hidden;padding: 3px;" >
        <form id="tbSlideshowAddForm" method="post">
            <table class="grid">
                <thead>
                <tr>
               ...
               <tbody class="list">
                   <tr>
                       <td>文章标题</td>
                       <td><input class="easyui-combobox" name="articleId" id="articleId" data-options="valueField:'id',textField:'title',panelHeight:'auto',panelMaxHeight:200,panelMinHeight:100"  style="width: 160px;height: 29px"/> </td>
                   </tr>
               </tbody>
                <tbody class="list">
                <tr>
                    <td>名称</td>
                    <td><input name="name" type="text" placeholder="请输入名称" class="easyui-validatebox span2" data-options="" value=""></td>
                </tr>
                <tr>
                    <td>图片</td>
                    <td>
                        ...
                        <input hidden="hidden" id="imagePath" type="text" name="imgPath">
                        </input>
                    </td>
                </tr>
                <tr>
                    <td>图片指向</td>
                    <td><input name="imgLink" type="text" placeholder="请输入名称" class="easyui-validatebox span2" data-options="" value=""></td>
                </tr>
                </tbody>
